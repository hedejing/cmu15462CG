...
public:
    ...
    virtual Vector3 compute_normal( const Vector2 &pos) const = 0;
...
class OpenglProject
{
    ...
    static const unsigned vertices_per_axis = 128;
public:
...
private:
    ...
    Scene scene;
    real_t height_map[vertices_per_axis][vertices_per_axis];
    Vector3 *mesh_normal;
    Vector3 height_map_normal[vertices_per_axis][vertices_per_axis];
    // TODO add any other private members/functions here.

    // since this has no meaningful or useful assignment/copy, prevent the
